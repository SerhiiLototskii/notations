...
const initialState: Array<notationType> = [
    {
        ...
        notationId: v1(),
        description: 'Сегодня было много гостей, пришел брат, сестра со своим парнем, а также бабушка и дедушка, осталась гора посуды, нужно будет купить робота и запрограммировать мыть посуду.'
    },
    {
        notationTitle: 'Рыбалка с дедушкой',
        notationId: v1(),
        description: 'Завтра мы с дедушкой договорились пойти на рыбалку. Помню как в детстве мы с ним ловили рыбу на местном озере, рыба оказалась сильнее дедушки, хорошо что он умеет плавать.'
    },
    {
